...
old_window1 = np.array(0)
old_window2 = np.array(0)
enable = 2;
while not done:    
    ...
    #print(data_filtered_normalized.shape)
    ...
    for i in range(steps):
        ...
        if(enable==0):
            voice_confidence = vad.is_voice(windowed_data_unfiltered[0],old_window1,old_window2)
            print(voice_confidence*100)
    ...
    if(enable>0):
        enable = enable - 1 
    old_window2 = old_window1
    old_window1 = windowed_data_unfiltered[0]